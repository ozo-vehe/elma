  ...
  import image5 from '../assets/images/footer5.webp'
  import image6 from '../assets/images/footer6.webp'

  // Variables
  const links = ["Home", "Shop", "Blog", "Product", "Brand", "Contact"];
  const footerImages = [
    { name: "image 1", src: image1 },
    { name: "image 2", src: image2 },
    { name: "image 3", src: image3 },
    { name: "image 4", src: image4 },
    { name: "image 5", src: image5 },
    { name: "image 6", src: image6 },
  ]

export default function Footer() {
return (
  <main className="bg-custom-dark-blue text-slate-200 flex flex-wrap items-start justify-center gap-8">
    <div className="w-300">
      <h1 className="oswald text-3xl mb-4">Our Mission</h1>
      <p className="text-sm text-custom-btn-gray">
        At Aroma, our mission is to revolutionize the way people 
      ...
      <div className="footerContactUs w-250">
        ...
        <div className="headOffice mb-6 flex flex-wrap items-start gap-4 text-sm">
          <div className="p-2 rounded-full bg-custom-blue h-8 w-8 relative">
            <img className="rotate-90 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" width="24" height="24" src="https://img.icons8.com/external-tanah-basah-glyph-tanah-basah/48/ffffff/external-send-user-interface-tanah-basah-glyph-tanah-basah.png" alt="external-send-user-interface-tanah-basah-glyph-tanah-basah"/>
          </div>
        ...
        <div className="phoneNumber mb-6 text-sm flex flex-wrap gap-4">
          <div className="p-2 rounded-full bg-custom-blue h-8 w-8 relative">
            <img className="-rotate-90 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" width="24" height="24" src="https://img.icons8.com/ios-filled/50/ffffff/phone.png" alt="phone"/>
          </div>
          <div className="details">
        ...
        <div className="email text-sm flex flex-wrap gap-4">
          <div className="p-2 rounded-full bg-custom-blue h-8 w-8 relative">
            <img className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/ffffff/mail.png" alt="mail"/>
          </div>
          <div className="details">
            <h3 className="mb-2">Email</h3>
            <p className="text-custom-btn-gray">aroma@website.com</p>
            <p className="text-custom-btn-gray">aromahq@website.com</p>
          </div>
        </div>
      </div>
    </div>
